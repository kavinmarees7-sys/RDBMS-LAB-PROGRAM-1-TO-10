...
select count(salary) as total_employees from Employee; select min(salary) as minumum_salary from Employee; select max(salary)as maximum_salary from Employee;
